...
freqlist_leipzig_citation <- function(pattern = NULL, corpus_file_names = corpus_files_path, case_insensitive = TRUE) {
  sent <- vector()
  out <- concord_leipzig(pattern = pattern, corpus_file_names, case_insensitive = case_insensitive)
